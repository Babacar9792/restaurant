...
export class CommandeService {
  ...
  constructor() {
   ...
   public  getAllCommande(user_id : number, date_debut : string, date_fin : string) : Observable<ResponseData<Commande>> {
  ...
  //  filterData(filtre : string, user_id : number, date_debut : string, date_fin : string) : Observable<ResponseData<Commande>>{
  //   if(filtre == "Tout"){
  //     return this.getAllCommande(user_id, date_debut, date_fin);
  //   }
  //   return this.getAllCommande(user_id, date_debut, date_fin).pipe(
  //     map(ele => {
